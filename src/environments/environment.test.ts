...
export const environment = {
  production: false,
  apiLogin: 'http://10.9.101.147/portal/api/account/login',
  apiAuthenToken: 'http://10.9.101.147/portal/api/account/AuthenToken',
  SECRET_APPTOKEN: 'YjRBRfYbbc',
  APPID: '82',
  api: 'http://10.9.101.147/RIS_REPORT_BE_DEV/api',
  // api: 'https://smartlifedev-proxy.segroup.co.th/RIS_REPORT_BE_DEV/api',
  //api:'http://localhost:8086/api',
  appVersion: 'v8.1.7',
  urlLogin: 'http://10.9.101.148:8080/smartLifePortal/Authen/Login',
