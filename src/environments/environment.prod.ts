...
export const environment = {
  production: true,
  apiLogin:'http://10.9.104.24:8080/portalecbrapi/api/account/login',
  apiAuthenToken:'http://10.9.104.24:8080/portalecbr/api/account/AuthenToken',
  SECRET_APPTOKEN:'YjRBRfYbbc',
  APPID:'82',
  api:'http://10.9.104.24:8080/RIS_REPORT_BE/api',
  //api:'http://localhost:8086/api',
  appVersion: 'v8.1.7',
  urlLogin:'http://10.9.104.25:8080/SmartlifePortal/Authen/Login',
